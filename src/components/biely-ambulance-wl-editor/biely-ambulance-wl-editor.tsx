...
@Component({
  tag: 'biely-ambulance-wl-editor',
  styleUrl: 'biely-ambulance-wl-editor.css',
  shadow: true,
})
export class BielyAmbulanceWlEditor {
  @Prop() entryId: string;
    ...
    return (
      <Host>
        ...
        <div class="actions">
          ...
          <md-filled-button id="confirm" onClick={() => this.updateEntry()}>
